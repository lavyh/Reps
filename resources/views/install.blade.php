...
<body>
    <div class="min-h-screen h-auto bg-gradient-to-r from-yellow-400 via-red-500 to-pink-500 ">
        <div class="flex h-full px-48 py-2">
            <div class="m-auto w-full text-sm">
                <div class="bg-gray-100 shadow overflow-hidden sm:rounded-lg">
                    <div class="px-4 py-4 border-b border-gray-200 sm:px-6">
                        <div class="flex justify-center items-center">
                            ...
                            <h2 class="pl-6 uppercase font-medium text-2xl text-gray-800">Repair Box Installation | <a style="color:red;" href="https://doniaweb.com" target="_blank">Nulled By DoniaWeB</a></h2>
                        </div>
                        @if (isset($error))
                            <div class="bg-red-200 border-l-4 border-red-500 p-4 mt-3 rounded-md">
                                <div class="flex">
                        ...
                        @endif
                        @if (isset($message))
                            <div class="bg-green-200 border-l-4 border-green-500 p-4 mt-2 rounded-md">
                                <div class="flex">
                                    <div class="flex-shrink-0">
                    ...
                    <div class="px-2 py-2 bg-white">
                        @if (isset($output))
                            <div class="flex justify-between">
                                <div class="overflow-auto h-64 bg-black text-xs text-green-400 col-span-2 w-1/2 px-2">
                                    <pre>{{ $output }}</pre>
                                </div>
                                <div class="col-span-2 w-1/2 px-2">
                                    <div>
                        ...
                        @else
                            ...
                            @else
                                <div class="flex justify-between">
                                    ...
                                    <div class="col-span-2 w-1/2 px-2 pt-8">
                                        <form method="post" action="/install.php">
                                            @csrf
                    ...
                    <p class="border-t p-2 text-gray-800 text-xs">
